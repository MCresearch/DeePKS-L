...
import subprocess
import numpy as np
from deepks.utils import load_sys_paths, get_sys_name, get_with_prefix, load_array
from deepks.core.ml.models.corrnet import CorrNet
from deepks.default import DEFAULT_FNAMES
...
def load_system_data(path):
    ...
    """
    from deepks.default import TYPE_NAME

    lattice_info = {}

    # Check if path is xyz file
    if path.endswith('.xyz'):
        from deepks.utils import parse_xyz
