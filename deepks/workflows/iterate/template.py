...
from deepks.workflows.defaults import SCF_CMD, TRN_CMD, DEFAULT_SCF_RES, DEFAULT_SCF_SUB_RES, DEFAULT_TRN_RES, DEFAULT_DPDISPATCHER_RES
...
def make_test_train(data_paths, model_file="model.pth", *,
    ...
    from deepks.ml.eval.test import main as test_func
    test_args.update(
